...
const data = {
  ...
  current_system: "Refer to the definitions of current system FIFA and France Football in Glossary section",
  current_system_FIFA: "FIFA Best system 2021 takes 3 candidates each vote and score them 5, 3 and 1 points individually",
  current_system_France_football: "Ballon D'or 2021 ranks 5 players from each counted vote 6, 4, 3, 2, 1 points, from most favoured to the least ",
